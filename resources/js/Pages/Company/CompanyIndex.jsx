      ...
      <div className="flex flex-1">
        ...
        <div className="w-full">
          ...
          <div className="flex flex-wrap justify-between p-4">
            <div className="w-full lg:w-1/2 bg-white h-full p-4 mb-4">
            <div className="p-4 flex flex-col">
                <h2 className="text-xl font-bold mb-2">Profile Company</h2>
                ...
                <div className="flex">
                  ...
                  <p className='w-3'>:</p>
                  <p className="w-2/3 text-lg">Batu aji</p>
                </div>
                <div className="flex">
                  <p className="w-1/4 text-lg">Field company</p>
                  <p className='w-3'>:</p>
                  <p className="w-2/3 text-lg">-</p>
                </div>
                <div className="flex">
                  <p className="w-1/4 text-lg">Type_company</p>
                  <p className='w-3'>:</p>
                  <p className="w-2/3 text-lg">-</p>
                </div>
                <div className="flex">
                  <p className="w-1/4 text-lg">Company size</p>
                  <p className='w-3'>:</p>
                  <p className="w-2/3 text-lg">1000</p>
                </div>
              </div>
            </div>
            <div className="w-full lg:w-1/2 bg-white h-full p-4 mb-4">
